...
Additionally, the -o flag supports some plugin-specific options:

- The `-o json_object 1` option can be used to force the model to reply with a valid JSON object. Note that your prompt must mention JSON for this to work.
